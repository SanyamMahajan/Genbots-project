  ...
  return (
    <div className="bg-gray-50 min-h-screen flex flex-col">
        ...
        <div className="container mx-auto px-6 py-8 flex items-center justify-between">
          ...
          <nav>
            <ul className="flex space-x-6">
              <li><a href="index.html" className="text-lg hover:text-yellow-300 transition">Home</a></li>
              <li><a href="about.html" className="text-lg hover:text-yellow-300 transition">About</a></li>
              <li><a href="contact.html" className="text-lg hover:text-yellow-300 transition">Contact</a></li>
            </ul>
          </nav>
        </div>
      </header>
      ...
      <main className="flex-grow container mx-auto px-6 py-12">
        ...
        <div id="submit" className="bg-white p-8 shadow-2xl rounded-2xl max-w-3xl mx-auto border border-indigo-500">
          <h2 className="text-2xl font-bold mb-6 text-gray-800 text-center">Submit Your Query</h2>
          <form className="space-y-6">
            <div>
              <label className="block text-gray-700 font-medium mb-2">
                Your Name <i className="fas fa-user text-indigo-500"></i>
              </label>
              <input 
                type="text" 
            ...
            <div>
              <label className="block text-gray-700 font-medium mb-2">
                Your Email <i className="fas fa-envelope text-indigo-500"></i>
              </label>
              <input 
                type="email" 
                className="w-full border border-gray-300 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-indigo-500" 
            ...
            <div>
              <label className="block text-gray-700 font-medium mb-2">
                Your Query <i className="fas fa-comment-dots text-indigo-500"></i>
              </label>
              <textarea 
                className="w-full border border-gray-300 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-indigo-500" 
                rows="5" 
      ...
      {/* Footer */}
      <footer className="bg-gradient-to-r from-indigo-700 to-indigo-900 text-white py-6 mt-12">
